...
function Header() {
  ...
  return (
    <>
      <div className="bg-[#0071dc] flex-col w-full min-h-24 rounded-b-2xl md:hidden">
        {!toggle && (
          <div className="h-[8vh] flex justify-between items-center p-2">
            <img
              ref={logoRef}
              src="/images/logo.png"
              alt="Logo"
      ...
      {toggle && (
        <div
          ref={sidebarRef}
          className="rounded-l-3xl fixed top-0 right-0 h-full w-[150px] bg-[#0071dc] text-[#D8D9DA] p-4 transition-transform duration-400 transform translate-x-0 z-50 flex justify-center"
        >
