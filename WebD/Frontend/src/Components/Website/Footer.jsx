...
const Footer = () => {
  return (
    <footer className="bg-[#0071DC] text-white py-5 mt-32">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start bg-[#0071DC] p-6 rounded-3xl">
          ...
          <div className="flex flex-col items-center md:items-start bg-[#0071DC] p-6 rounded">
