...
csv_path = r"D:\Walmart-sparkathon\Walmart Camera\people_count.csv"
...
with open(csv_path, mode='a', newline='') as csv_file:
    ...
    csv_writer.writerow(['Timestamp', 'Max People Left', 'Max People Right'])
    ...
    while True:
        ...
        if time.time() - start_time >= 10:
            ...
            csv_writer.writerow([timestamp, max_people_left, max_people_right])
